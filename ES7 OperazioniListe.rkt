...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname |ES7 OperazioniListe|) (read-case-sensitive #t) (teachpacks ((lib "drawings.ss" "installed-teachpacks"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "drawings.ss" "installed-teachpacks")) #f)))
